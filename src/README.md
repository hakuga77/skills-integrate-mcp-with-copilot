...
Activity registrations and teacher sessions are stored in memory, which means they reset when the server restarts. Teacher credentials are loaded from `teachers.json`.
